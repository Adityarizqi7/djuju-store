    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/scss/admin/component/_btntotop.scss',
                'resources/scss/admin/note/_note.scss',
                'resources/scss/admin/report/_report.scss',
                ...
                'resources/scss/admin/report/_reportyear.scss',
                'resources/scss/admin/report/_reportweek.scss',
                'resources/scss/admin/report/_reportmonth.scss',
                'resources/scss/admin/report/_reportrange.scss',
                'resources/scss/admin/report/_reportperiod.scss',
