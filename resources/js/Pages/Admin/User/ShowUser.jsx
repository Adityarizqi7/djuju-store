...
import '../../../../scss/admin/user/_showuser.scss';
    ...
    return (
        <div className="edit-component">
            <div id="container_edit">
                ...
                {
                    success === true &&
                    <SuccessAlert msg_primary={'Berhasil diubah! '} time={5000} msg_detail={`Pembaruan Pengguna '${user?.name}' telah disimpan.`} className={'mt-5'} />
                }
