...
import '../../../../scss/admin/report/_reportyear.scss';

import { Fragment } from 'react';
import AdminLayout from "@/Layouts/AdminLayout";
import DashboardLayout from '../DashboardLayout';
import { Dialog, Transition } from '@headlessui/react';
import {  yearY } from "@/Utils/Date";
...
export default function ReportYear({notes}) {
    ...
    return (
        <div className="report-year-component">
            <div id="container_report_year">
                <Breadcrumbs className='mt-5 bg-gray-200'>
                    ...
                    <Link href="/sales-note/report-period/year" className='montserrat font-medium'>Periode Tahunan</Link>
                </Breadcrumbs>
                <div className="date-download-section flex 3xs:flex-col gap-5 items-center justify-between mt-10">
                    ...
                    <input type="number" id="date" name='datekey' placeholder='YYYY' value={date} onChange={handleYearChange} className='montserrat rounded-[5px] 3xs:w-full w-[7rem] bg-blue-600 border-0 text-white' />
                </div>
                {
                    dialogDownloadFile &&
